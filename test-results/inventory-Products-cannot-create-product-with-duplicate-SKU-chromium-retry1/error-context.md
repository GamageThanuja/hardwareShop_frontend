...
- Name: inventory.spec.ts >> Products >> cannot create product with duplicate SKU
- Location: tests/e2e/inventory.spec.ts:259:2
...
- dialog "New Product":
  ...
  - group:
    - text: SKU
    - textbox "HW-001": HND-HAM-001
  - group:
    - text: Barcode
    - textbox "Optional": Duplicate Hammer
  - group:
    - text: Name
